#!/usr/bin/env python3
# -*- coding: utf-8 -*- Time-stamp: <2020-11-05 14:31:02 sander>
    ...
    def makeruns(cls, fullncfile, outputdir, write_status=False):
        ...
        for line in range(lines):
            ...
            for var in ncid_in.variables:
                ...
                if (var[0:4]=='nml_'):
                    nmldict['CAABA'][var[4:]] = ncid_in.variables[var][line].tolist()
                else:
                    if var not in ncid_in.dimensions: # exclude lon, lat, lev
