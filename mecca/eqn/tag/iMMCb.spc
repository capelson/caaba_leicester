...
{ mz_sg_20170116+ : iso CH4 monte-carlo box-model for PALMOD issues }
{ CH4 compartments }
...
{ loss PTs }
  PTLCH4TN        =   C +  4H            ; {@CH_4}              {methane loss in trop. NH}
  PTLCH4TS        =   C +  4H            ; {@CH_4}              {methane loss in trop. SH}
  PTLCH4SN        =   C +  4H            ; {@CH_4}              {methane loss in strat. NH}
  PTLCH4SS        =   C +  4H            ; {@CH_4}              {methane loss in strat. SH}
