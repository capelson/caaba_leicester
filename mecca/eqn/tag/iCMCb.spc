{Time-stamp: <2019-01-07 11:58:59 sander>}
...
{ CO2 compartments }
   ...
   RLL = C + 2O ; {RLL @CO_2} {Remote low-latitude CO2 compartment}
   RHL = C + 2O ; {RHL @CO_2} {Remote high-latitude CO2 compartment}
   BL  = C + 2O ; {IBL @CO_2} {BL CO2 compartment}
   UA  = C + 2O ; {IUA @CO_2} {Updraft air CO2 compartment}
...
FXentH = C + 2O ; {@CO_2 RHL->UA entrainment flux}      {CO2 entrainment flux}
FXdetH = C + 2O ; {@CO_2 RHL->UA detrainment flux}      {CO2 detrainment flux}
FXentL = C + 2O ; {@CO_2 RLL entrainment flux}      {CO2 entrainment flux}
FXdetL = C + 2O ; {@CO_2 RLL detrainment flux}      {CO2 detrainment flux}
...
{ other than CO2 tracers }
 ...
 RLL_CO = C +  O ; {RLL CO} {Remote low-latitude CO compartment}
 RHL_CO = C +  O ; {RHL CO} {Remote high-latitude CO compartment}
  BL_CO = C +  O ; {IBL CO} {BL CO compartment}
  UA_CO = C +  O ; {IUA CO} {Updraft air CO compartment}
  CM_CO = C +  O ; {CM  CO} {CO measured by CARIBIC}
 RLL_O3 =     3O ; {RLL O3} {Remote low-latitude O3 compartment}
 RHL_O3 =     3O ; {RHL O3} {Remote high-latitude O3 compartment}
  BL_O3 =     3O ; {IBL O3} {BL O3 compartment}
  UA_O3 =     3O ; {IUA O3} {Updraft air O3 compartment}
  CM_O3 =     3O ; {CM  O3} {O3 measured by CARIBIC}
RLL_CH4 = C + 4H ; {RLL CH4} {Remote low-latitude CH4 compartment}
RHL_CH4 = C + 4H ; {RHL CH4} {Remote high-latitude CH4 compartment}
 BL_CH4 = C + 4H ; {IBL CH4} {BL CH4 compartment}
 UA_CH4 = C + 4H ; {IUA CH4} {Updraft air CH4 compartment}
 CM_CH4 = C + 4H ; {CM  CH4} {CH4 measured by CARIBIC}
RLL_N2O = 2N + O ; {RLL N2O} {Remote low-latitude N2O compartment}
RHL_N2O = 2N + O ; {RHL N2O} {Remote high-latitude N2O compartment}
 BL_N2O = 2N + O ; {IBL N2O} {BL N2O compartment}
 UA_N2O = 2N + O ; {IUA N2O} {Updraft air N2O compartment}
 CM_N2O = 2N + O ; {CM  N2O} {N2O measured by CARIBIC}
RLL_SF6 = S + 6F ; {RLL SF6} {Remote low-latitude SF6 compartment}
RHL_SF6 = S + 6F ; {RHL SF6} {Remote high-latitude SF6 compartment}
 BL_SF6 = S + 6F ; {IBL SF6} {BL SF6 compartment}
 UA_SF6 = S + 6F ; {IUA SF6} {Updraft air SF6 compartment}
 CM_SF6 = S + 6F ; {CM  SF6} {SF6 measured by CARIBIC}

{RLL_xxx = C + 2O ;} {RLL xxx} {Remote low-latitude xxx compartment}
{RHL_xxx = C + 2O ;} {RHL xxx} {Remote high-latitude xxx compartment}
{ BL_xxx = C + 2O ;} {IBL xxx} {BL xxx compartment}
{ UA_xxx = C + 2O ;} {IUA xxx} {Updraft air xxx compartment}
