...
F90            = gfortran
F90FLAGS       = -cpp -g -O0 -Wall -ffree-line-length-none -fno-range-check -fbacktrace -fbounds-check -fdump-core -fimplicit-none -fall-intrinsics -fallow-invalid-boz -Wno-unused-variable -frecursive -Wno-unused-dummy-argument -Wno-conversion -Winteger-division
NETCDF_INCLUDE = -I/usr/include
NETCDF_LIB     = -L/usr/lib/x86_64-linux-gnu -lnetcdf -lnetcdff
