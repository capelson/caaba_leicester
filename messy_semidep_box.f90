...
!!     !IF (ind_NO /= 0) c(ind_NO) = (241.3 * (SIN(3.14159*((MODULO(time_of_day+5.5,24.)-13)/24.)))**4. + 7.) * 1.E-9 * cair
!     IF (ind_NO2 /= 0) c(ind_NO2) = (time_IST * (sin(2 * 3.14159 *(time_IST-1.4)/24.))**2 + 32 ) * 1.E-9* cair
...
!!      IF (ind_NO /= 0) c(ind_NO) = 3.16E-9 * cair
!!     ENDIF
!!     IF (time_of_day == 1.) THEN
!!      IF (ind_NO /= 0) c(ind_NO) = 2.45E-9 * cair
!!     ENDIF
!!     IF (time_of_day == 2.) THEN
!!      IF (ind_NO /= 0) c(ind_NO) = 2.02E-9 * cair
!!     ENDIF
!!     IF (time_of_day == 3.) THEN
!!      IF (ind_NO /= 0) c(ind_NO) = 1.64E-9 * cair
!!     ENDIF
!!     IF (time_of_day == 4.) THEN
!!      IF (ind_NO /= 0) c(ind_NO) = 1.08E-9 * cair
!!     ENDIF
!!     IF (time_of_day == 5.) THEN
!!      IF (ind_NO /= 0) c(ind_NO) = 0.85E-9 * cair
!!     ENDIF
!!     IF (time_of_day == 6.) THEN
!!      IF (ind_NO /= 0) c(ind_NO) = 1.04E-9 * cair
!!     ENDIF
!!     IF (time_of_day == 7.) THEN
!!      IF (ind_NO /= 0) c(ind_NO) = 2.06E-9 * cair
!!     ENDIF
!!     IF (time_of_day == 8.) THEN
!!      IF (ind_NO /= 0) c(ind_NO) = 6.72E-9 * cair
!!     ENDIF
!!     IF (time_of_day == 9.) THEN
!!      IF (ind_NO /= 0) c(ind_NO) = 8.01E-9 * cair
!!     ENDIF
!!     IF (time_of_day == 10.) THEN
!!      IF (ind_NO /= 0) c(ind_NO) = 6.60E-9 * cair
!!     ENDIF
!!     IF (time_of_day ==11.) THEN
!!      IF (ind_NO /= 0) c(ind_NO) = 5.19E-9 * cair
!!     ENDIF
!!     IF (time_of_day ==12.) THEN
!!      IF (ind_NO /= 0) c(ind_NO) = 4.65E-9 * cair
!!     ENDIF
!!     IF (time_of_day ==13.) THEN
!!      IF (ind_NO /= 0) c(ind_NO) = 4.04E-9 * cair
!!     ENDIF
!!     IF (time_of_day ==14.) THEN
!!      IF (ind_NO /= 0) c(ind_NO) = 3.73E-9 * cair
!!     ENDIF
!!     IF (time_of_day ==15.) THEN
!!      IF (ind_NO /= 0) c(ind_NO) = 3.66E-9 * cair
!!     ENDIF
!!     IF (time_of_day ==16.) THEN
!!      IF (ind_NO /= 0) c(ind_NO) = 4.12E-9 * cair
!!     ENDIF
!!     IF (time_of_day ==17.) THEN
!!      IF (ind_NO /= 0) c(ind_NO) = 4.72E-9 * cair
!!     ENDIF
!!     IF (time_of_day ==18.) THEN
!!      IF (ind_NO /= 0) c(ind_NO) = 4.91E-9 * cair
!!     ENDIF
!!     IF (time_of_day ==19.) THEN
!!      IF (ind_NO /= 0) c(ind_NO) = 5.42E-9 * cair
!!     ENDIF
!!     IF (time_of_day ==20.) THEN
!!      IF (ind_NO /= 0) c(ind_NO) = 5.09E-9 * cair
!!     ENDIF
!!     IF (time_of_day ==21.) THEN
!!      IF (ind_NO /= 0) c(ind_NO) = 4.66E-9 * cair
!!     ENDIF
!!     IF (time_of_day ==22.) THEN
!!      IF (ind_NO /= 0) c(ind_NO) = 4.15E-9 * cair
!!     ENDIF
!!     IF (time_of_day ==23.) THEN
!!      IF (ind_NO /= 0) c(ind_NO) = 3.64E-9 * cair
!!     ENDIF
!      IF (time_of_day >= 0. .AND. time_of_day <= 12.) THEN 
!        IF (ind_NO /= 0) c(ind_NO) = ((exp(0.087*(MODULO(time_of_day,24.)**(0.7)))*(10-(MODULO(time_of_day,24.)/10))* &
!                                    (SIN(5.78*((MODULO(time_of_day,24.)-2.67)/24.)))**6.) + 0.5) * 1.E-9 * cair
!      ENDIF
!      IF (time_of_day >= 12. .AND. time_of_day <= 23.) THEN
!        IF (ind_NO /= 0) c(ind_NO) = ((exp(-0.33*(MODULO(time_of_day,24.)**(0.7)))*(20-(MODULO(time_of_day,24.)/10))* &
!                                    (SIN(5.47*((MODULO(time_of_day,24.)+12.16)/24.)))**2.) + 8) * 1.E-9 * cair
!      ENDIF
...
!      IF (ind_NO /= 0) c(ind_NO) = (0.0+(9.*(exp((-(MODULO(time_of_day,24.)-10.)**2/5.)))) + &
!                                   (6.*(exp(-((MODULO(time_of_day,24.)-14.)**2)/6.))))  * 1.E-9 * cair
!
...
!      IF (ind_O3/= 0) c(ind_O3)= c(ind_O3)+ 4.0335E12 * fct
!      IF (ind_NO2/= 0) c(ind_NO2)= c(ind_NO2)+ 3.18E11 * fct
